    ...
    return (
        <div className="reg-teams-container">
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px' }}>
                ...
                <div>
                    <button className="reg-teams-btn export" onClick={exportPDF} style={{ marginRight: '10px' }}>Download PDF</button>
                    <button className="reg-teams-btn" style={{ backgroundColor: '#dc3545', backgroundImage: 'none' }} onClick={clearData}>Clear Data</button>
                </div>
            </div>
            ...
            {loading ? (
                ...
                <div className="reg-teams-table-wrapper" id="teamsTable">
                    <table className="reg-teams-table">
                        ...
                        <tbody>
                            {teams.length === 0 ? (
                                <tr>
                                    <td colSpan="6" style={{ textAlign: 'center' }}>No teams registered yet.</td>
                                </tr>
                            ) : (
                                teams.map((team, index) => (
                                    <tr key={index}>
                                        ...
                                        <td>{team.leaderDisplay}</td>
                                        <td>{team.membersDisplay}</td>
                                        <td style={{ fontSize: '10px', color: '#666', width: '100px' }}>
